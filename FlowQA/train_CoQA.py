...
parser.add_argument('--self_attention_opt', type=int, default=1) 
...
parser.add_argument('--valid_file', default='CoQA/dev.json')
...
def main():
    ...
    CoQAEval = CoQAEvaluator(args.valid_file)
    ...
    if args.resume:
        ...
        for i in range(checkpoint['epoch']):
            random.shuffle(list(range(len(train))))  
        if args.reduce_lr:
